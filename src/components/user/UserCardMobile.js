				...
				<section className=' user-card-mobile__nav'>
						...
						<ul>
							...
							<li>
								<a
									...
									<p className='options'>Edit Photo</p>
								</a>
							</li>
							<li>
								<a
									...
									<p className='options'>Edit Profile</p>
								</a>
							</li>
						</ul>
					</div>
					<div className='user-card-mobile__nav-right'>
						<ul>
							<li>
								<a href='/gigs'>
									<p className='options'>Gigs</p>
								</a>
							</li>
							<li>
								<a href='/browse-profile'>
									<p className='options'>People</p>
								</a>
							</li>
							<li>
								<a
									...
									href='#'
									data-toggle='modal'
									data-target='#addGigModal'>
									<p className='options'>Add Gig</p>
								</a>
							</li>
						</ul>
					</div>
